...
<body>
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark"></div>
        </div>
        <!-- Navbar & Hero End -->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        ...
                                        <label for="datetime">Waktu dan Tempat</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" id="select1">
                                          <option value="1">Menyukai</option>
                                          <option value="2">Keluhan</option>
                                          <option value="3">Memberi Saran</option>
                                        </select>
                                        <label for="select1">Jenis Contact</label>
                                      </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
