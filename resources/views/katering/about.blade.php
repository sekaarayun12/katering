            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Radara</h1>
                        <p class="mb-4">ini merupakan project kami dalam pembuatan web untuk catering agar lebih memudahkan dalam menginfokan macam macam pesanan dan harga secara online</p>
                        <p class="mb-4">catering kami bernama radara katering yang berada di mendit barat yang menyediakan banyak menu menu menarik untuk acara acara.</p>
